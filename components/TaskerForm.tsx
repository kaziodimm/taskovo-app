...
export function TaskerForm() {
  return (
    <form className="tasker-card" action={createTaskerProfile}>
      ...
      <label>Kontakt<input name="contact" type="text" placeholder="+420 ... / Telegram / email" required /></label>
      <label>Krátký profil<textarea name="bio" rows={4} placeholder="Mám auto, večer volno a umím montovat nábytek." /></label>
      <button className="button primary" type="submit">Odeslat registraci</button>
    </form>
  );
}
