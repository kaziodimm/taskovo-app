    ...
    <article className="task-card">
      ...
      <details>
        ...
        <ul className="offer-list">
          {offers.length ? offers.map((offer) => <li key={offer.id}><strong>{offer.tasker_name}</strong><span>{money(offer.price_czk)} Kč</span><p>{offer.message}</p></li>) : <li className="muted-row">Zatím bez nabídek.</li>}
        </ul>
